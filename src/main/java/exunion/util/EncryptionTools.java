...
public class EncryptionTools {
	...
	public static String HmacSHA256(String secret, String data){
		return HmacSHA(secret, data, "HmacSHA256");
	}
	
	public static byte[] HmacSHA256Hex(String secret, String data){
		return HmacSHAHex(secret, data, "HmacSHA256");
	}
	...
	public static String HmacSHA512(String secret, String data){
		return HmacSHA(secret, data, "HmacSHA512");
	}

	public static String HmacSHA1(String secret, String data){
	    return HmacSHA(secret, data, "HmacSHA1");
    }

    public static byte[] HmacSHA1Hex(String secret, String data){
	    return HmacSHAHex(secret, data, "HmacSHA1");
    }

	public static String HmacMd5(String secret, String data){
		return HmacSHA(secret, data, "HmacMD5");
	}
	...
	private static String HmacSHA(String secret, String data, String algorithm){
		return Hex.encodeHexString(HmacSHAHex(secret, data, algorithm));
	}
	
	private static byte[] HmacSHAHex(String secret, String data, String algorithm){
	...
	public static void main(String[] args){
		...
		//System.out.println(HmacSHA("6186ec9223b8f8e3fe28b5f5c831427ed99950a6", "accesskey=6d8f62fd-3086-46e3-a0ba-c66a929c24e2&method=getAccountInfo", "HmacMD5"));
